...
int main(int argc, char **argv)
{
    ...
    KDDockWidgets::QtWidgets::MainWindow mainWindow(
        0, QStringLiteral("MyMainWindow"), KDDockWidgets::MainWindowOption_HasCentralWidget);
    ...
    auto mdiWidget1 =
        new KDDockWidgets::QtWidgets::DockWidget(0, QStringLiteral("MDI widget1"), options);
    mdiWidget1->setWidget(new MyWidget1());

    auto mdiWidget2 =
        new KDDockWidgets::QtWidgets::DockWidget(0, QStringLiteral("MDI widget2"), options);
    mdiWidget2->setWidget(new MyWidget2());

    auto mdiWidget3 =
        new KDDockWidgets::QtWidgets::DockWidget(0, QStringLiteral("MDI widget3"), options);
    mdiWidget3->setWidget(new MyWidget3());

    auto mdiArea = new KDDockWidgets::QtWidgets::MDIArea(0);
